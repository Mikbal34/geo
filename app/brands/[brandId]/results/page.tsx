              ...
              <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-200 p-8">
                ...
                <div className="mb-6 pb-6 border-b border-slate-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-slate-900 mb-2">Prompt</h3>
                      <p className="text-slate-700 leading-relaxed">{prompt.prompt_text}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  {runs
                    ...
                    .map((run) => (
                      <div key={run.id} className="border border-slate-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
                        {/* LLM Header */}
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-3">
                            <div className={`px-4 py-2 rounded-lg bg-gradient-to-r ${getLLMColor(run.llm)} text-white font-bold`}>
                              {run.llm.toUpperCase()}
                            </div>
